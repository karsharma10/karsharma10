...
|:---------:|:----------------------------------:|
| Data Scientist | Automated tedious business analyst process that sourced projects for millions of dollars using Python, Apache Airflow, Docker Containers, and Selenium. Currently utilizing the Salesforce platform to automate employee uploading information.|
